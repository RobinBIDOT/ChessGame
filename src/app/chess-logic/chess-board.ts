...
export class ChessBoard {
  ...
  private _victoryMessage: string | undefined;
  ...
  public get victoryMessage(): string | undefined {
    return this._victoryMessage;
  }
  ...
  private isGameFinished(): boolean {
    ...
    if (!this._safeSquares.size) {
      if (this._checkState.isInCheck) {
        ...
        this._victoryMessage = `${prevPlayer} wins by checkmate`;
      } else {
